...
$APPLICATION->SetTitle("Страница не найдена");?>
    ...
    <div class="page__main error-page">
        <div class="mu-container">
            <div class="error-page__inner">
                ...
                <p class="error-page__subtitle">
                    К сожалению, данная страница не существует, но мы скоро это исправим
                </p>
                <a class="error-page__link" href="/">Вернуться на главную</a></div>
        </div>
    </div>

<!--	<div class="bx-404-container">-->
<!--		<div class="bx-404-block"><img src="--><?php //=SITE_DIR?><!--images/404.png" alt=""></div>-->
<!--		<div class="bx-404-text-block">Неправильно набран адрес, <br>или такой страницы на сайте больше не существует.</div>-->
<!--		<div class="">Вернитесь на <a href="--><?php //=SITE_DIR?><!--">главную</a> или воспользуйтесь картой сайта.</div>-->
<!--	</div>-->
