...
<div class="slider-container">
    <? if($arResult["ITEMS"] && $arResult["ID"] == 6) { ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-img-container">
                            ...
                            <a class="btn btn-primary"
                               href="<? echo $arItem["DETAIL_PAGE_URL"] ?>">Купить &nbsp;&nbsp;<img src="<?=SITE_TEMPLATE_PATH?>/images/ticket.svg"
                                                                                                    alt=""></a>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                <div class="afisha-date">
                                    <?
                                    $date = explode(".",$arItem['PROPERTIES']['DATE']['VALUE']);
