...
?>
    ...
    <div class="mu-content-page__inner">
        <div class="mu-content-page__main">
            <div class="mu-content-page__main-tags"><span class="mu-content-page__tag">Событие</span></div>
            <div class="mu-content-page__main-info">
                <div class="mu-content-page__author">
                    <div class="mu-content-page__author-image"><img src="<?= $arResult["AUTHOR"]["PERSONAL_PHOTO"]["SRC"] ?>"></div>
