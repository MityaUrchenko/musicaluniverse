...
<div class="mu-registration__main">
    <span class="mu-registration__title">Зарегистрироваться</span>
    <form class="mu-registration__form" method="post" action="<?=$arResult["AUTH_URL"]?>" name="regform">

        <div class="mu-input">
            <div class="mu-input__wrap">
                <input class="mu-input__input" type="text" name="USER_NAME"
                       placeholder="<?=GetMessage("AUTH_NAME")?>" value="<?=$arResult["USER_NAME"]?>" required></div>
        </div>
        <div class="mu-input">
            <div class="mu-input__wrap">
                <input class="mu-input__input" type="text" name="USER_LAST_NAME"
                       placeholder="<?=GetMessage("AUTH_LAST_NAME")?>" value="<?=$arResult["USER_LAST_NAME"]?>" required></div>
        </div>
        <div class="mu-input">
            <div class="mu-input__wrap">
                <input class="mu-input__input" type="text" name="USER_LOGIN"
                       placeholder="<?=GetMessage("AUTH_LOGIN_MIN")?>" value="<?=$arResult["USER_LOGIN"]?>" required></div>
        </div>

        <?if($arResult["EMAIL_REGISTRATION"]):?>
            <div class="mu-input">
                <div class="mu-input__wrap">
                    <input class="mu-input__input" type="text" name="USER_EMAIL"
                           placeholder="<?=GetMessage("AUTH_EMAIL")?>"
                           maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" required></div>
            </div>
        <?endif?>
            ...
            <div class="mu-input__wrap">
                <div class="mu-input__inner-password js-input-password">
                    <input class="mu-input__input"
                           ...
                           name="USER_PASSWORD"
                           placeholder="Пароль"
                           value="<?=$arResult["USER_PASSWORD"]?>" required
                           maxlength="255"
                           autocomplete="off">
                    <span class="mu-input__password-icon"></span></div>
            </div>
        </div>
            ...
            <div class="mu-input__wrap">
                <div class="mu-input__inner-password js-input-password">
                    <input class="mu-input__input"
                           ...
                           value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" required
                           maxlength="255"
                           autocomplete="off">
        ...
        <div class="mu-registration__form-controls">
            <button class="mu-btn mu-btn--round mu-btn--filled"><span>Зарегистрироваться</span></button>
        </div>
    </form>
</div>

<div class="mu-registration__bottom">
    <div class="mu-registration__bottom-item"><a class="mu-registration__link" href="#">Стать Автором</a></div>
    <div class="mu-registration__bottom-item"><a class="mu-registration__link" href="#">Я Представитель</a></div>
    <div class="mu-registration__bottom-item"><a href="#" rel="nofollow" class="mu-registration__link  js-login-btn">Войти</a></div>
</div>
